...
my $USAGE = "\nperl $0 [database name] [start of the fragment (number of bp after transcript end)] [end of the fragment (number of bp after end)] [gene|gene:protein_coding]\n\n";
...
my $MINIMUM_LENGTH = $END - $START - 10;
my $MAXIMUM_LENGTH = $END - $START + 10;
...
my $tab_out = "$dbname\_downstream_$START\_$END\.tab";
my $fa_out = "$dbname\_downstream_$START\_$END\.fa";
