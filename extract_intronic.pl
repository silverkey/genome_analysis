...
my $usage = "\nTHIS SCRIPT MUST BE RUNNED AFTER YOU HAVE DEFINED THE INTERGENICs!!!\n";
$usage .= "INTERGENICS SHOULD ALSO BE PRESENT INTO THE DB!!!!\n\n";
$usage .= "\n\tperl $0 [db] [type (e.g.: exon or exon:protein_coding)] [populate-db: 1|0]\n\n";
...
# FILES AND DATABASES:
my $dbname = $ARGV[0];
my $faname = "$dbname\_intronic.fa";
my $tabname = "$dbname\_intronic.tab";
open(INTER,">$tabname");
