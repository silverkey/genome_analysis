pdf(file='FC_single_bases.pdf',paper='a4',width=8.3,height=11.7,pointsize=8,title='TP single bases charts')
a=read.table(file='FC_M1_promoter_1000_500.counts',header=T)
...
pdf(file='FC_multi_bases.pdf',paper='a4',width=8.3,height=11.7,pointsize=8,title='TP multiple bases charts')
...
pdf(file='FC_gc.pdf',paper='a4',width=8.3,height=11.7,pointsize=8,title='TP GC content charts')
par(mfrow=c(2,2),lwd=2/96)
a = read.table(file='FC_M1_promoter_1000_500.gc',header=T,comment.char='')
hist(a[,3],breaks=seq(0,200,4),main='Range: TSS-1000/+500',col=8,xlab='Number of CGs',ylab='Number of genes')
a = read.table(file='FC_M1_promoter_400_400.gc',header=T,comment.char='')
hist(a[,3],breaks=seq(0,140,2),main='Range: TSS-400/+400',col=8,xlab='Number of CGs',ylab='Number of genes')
a = read.table(file='FC_M1_promoter_200_200.gc',header=T,comment.char='')
hist(a[,3],breaks=seq(0,70,1),main='Range: TSS-200/+200',col=8,xlab='Number of CGs',ylab='Number of genes')
a = read.table(file='FC_M1_promoter_20_20.gc',header=T,comment.char='')
hist(a[,3],breaks=seq(0,15,1),main='Range: TSS-20/+20',col=8,xlab='Number of CGs',ylab='Number of genes')
dev.off()

pdf(file='FC_single_bases_ZOOM.pdf',paper='a4',width=8.3,height=11.7,pointsize=8,title='PT sinlge bases charts')
a=read.table(file='FC_M1_promoter_1000_500.counts',header=T)
par(mfrow=c(4,1),lwd=2/96)
...
pdf(file='FC_multi_bases_ZOOM.pdf',paper='a4',width=8.3,height=11.7,pointsize=8,title='PT multiple bases charts')
par(mfrow=c(2,1),lwd=2/96)
