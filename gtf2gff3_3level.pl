...
#
# Downloaded from the git repository of Jason on 2011/05/24 at
# https://github.com/hyphaltip/genome-scripts/raw/master/data_format/gtf2gff3_3level.pl
#
# Converting JGI gff (which really are gtf) the transcript [id] will be present as t_[id]
# in the last column preceded by Alias=
# 
# At least for Fragiliaropsis gene/transcript/protein id seems to be represented by the
# same number
#
